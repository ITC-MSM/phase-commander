...
- **Distinct cards implicated:** 4713
- **Total card appearances across root causes:** 4746 (a card may appear under more than one root cause when it exhibits multiple distinct misparses)
